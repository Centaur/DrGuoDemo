...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'img',
            type:'image',
            rect:['143px','383px','504px','297px','auto','auto'],
...
"Symbol_a": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid55", tween: [ "transform", "${_a}", "rotateZ", '2deg', { fromValue: '-4deg'}], position: 0, duration: 125 },
            { id: "eid58", tween: [ "transform", "${_a}", "rotateZ", '-4deg', { fromValue: '2deg'}], position: 125, duration: 125 }         ]
      }
   }
},
"Symbol_i": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid84", tween: [ "transform", "${_i}", "rotateZ", '-1deg', { fromValue: '5deg'}], position: 0, duration: 125 },
            { id: "eid87", tween: [ "transform", "${_i}", "rotateZ", '5deg', { fromValue: '-1deg'}], position: 125, duration: 125 }         ]
      }
   }
},
"Symbol_t": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid91", tween: [ "transform", "${_t}", "rotateZ", '-3deg', { fromValue: '3deg'}], position: 0, duration: 130 },
            { id: "eid93", tween: [ "transform", "${_t}", "rotateZ", '3deg', { fromValue: '-3deg'}], position: 130, duration: 120 }         ]
      }
   }
},
"Symbol_o": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid97", tween: [ "transform", "${_o}", "rotateZ", '-3deg', { fromValue: '5deg'}], position: 0, duration: 120 },
            { id: "eid99", tween: [ "transform", "${_o}", "rotateZ", '5deg', { fromValue: '-3deg'}], position: 120, duration: 130 },
            { id: "eid100", tween: [ "transform", "${_o}", "rotateZ", '2deg', { fromValue: '5deg'}], position: 250, duration: 0 }         ]
      }
   }
},
"happy": {
