...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid108", tween: [ "style", "${_text01-a}", "clip", [0,155,53,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,0,53,0]}], position: 9000, duration: 420 },
            { id: "eid111", tween: [ "style", "${_text02-a}", "clip", [0,144,53,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,0,53,0]}], position: 11750, duration: 412 },
            { id: "eid114", tween: [ "style", "${_btnA-f}", "opacity", '1', { fromValue: '0'}], position: 9420, duration: 387 },
            { id: "eid117", tween: [ "style", "${_btnB-f}", "opacity", '1', { fromValue: '0'}], position: 12162, duration: 369 }         ]
      }
   }
},
"title": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid139", tween: [ "style", "${_title-a}", "clip", [0,426,48,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,0,48,0]}], position: 250, duration: 1250 },
            { id: "eid133", tween: [ "style", "${_title-b2}", "clip", [0,596,40,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,0,40,0]}], position: 1750, duration: 1250 }         ]
      }
   }
},
"dog-tail": {
