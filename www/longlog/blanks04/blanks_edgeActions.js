   ...
   (function(symbolName) {
       ...
       Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function (sym, e) {
           ...
           function init() {
               ...
               sym.getSymbol('Symbol_n').$('n').draggable({opacity: 0.5, revert: on_revert, start: all_start, drag: all_drag});
               sym.getSymbol('Symbol_k').$('k').draggable({opacity: 0.5, revert: on_revert, start: all_start, drag: all_drag});
               sym.getSymbol('Symbol_e').$('e').draggable({opacity: 0.5, revert: on_revert, start: all_start, drag: all_drag});
